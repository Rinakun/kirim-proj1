...
document.addEventListener("DOMContentLoaded", function () {  
    ...
    window.renderQuestions = function () {  
        ...
        for (  
            ...
            // Determine the category and update the question text  
            let category = "";  
            ...
            } else if (text.includes("DISLEKSIA")) {  
                category = "DISLEKSIA";  
                text = text.replace("DISLEKSIA", "");  
            } else if (text.includes("PENDENGARAN")) {  
                category = "PENDENGARAN";  
                text = text.replace("PENDENGARAN", "");  
            }  
    
            // Update the innerHTML of the questionDiv with the modified text  
